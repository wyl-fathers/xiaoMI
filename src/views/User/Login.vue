    ...
    <div id="custom_display_4" class="n-footer">
      <div class="nf-link-area clearfix">
        <ul class="lang-select-list">
          <li>
            <div data-lang="zh_CN" class="lang-select-li current">简体|</div>
          </li>
          <li>
            <div data-lang="zh_TW" class="lang-select-li">繁体 |</div>
          </li>
          <li>
            <div data-lang="en" class="lang-select-li">English |</div>
          </li>
          <li>
            <div>常见问题 |</div>
          </li>
...
.header_tit {
  ...
  padding: 30px 0 10px;
  .milogo {
    background-image: url(../../../public/img/milogo.png);
    width: 48px;
    height: 48px;
    margin: 0 auto 15px;
    display: block;
    background-image: -webkit-image-set(
      url(../../../public/img/milogo.png) 1x,
      url(../../../public/img/milogo2x.png) 2x
    );
  }
  .header_tit_txt {
    font-size: 0.18rem;
...
.btn_sns_icontype {
  background: url(../../../public/img/type.png) no-repeat;
  display: block;
  width: 18px;
  height: 18px;
  margin: 5px auto 0;
