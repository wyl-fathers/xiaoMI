...
export default {
  ...
  mounted() {
    axios({
      ...
      url: "/v1/home/page",
      data:
        "client_id=180100031051&channel_id=0&webp=1&page_type=activity&page_id=8235"
    }).then(resp => {
